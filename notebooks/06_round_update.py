...
X_train = matchup_df[FEATURE_COLS].fillna(0).values
...
xgb_model = xgb.XGBClassifier(**best_xgb_params, eval_metric="logloss", use_label_encoder=False)
...
if new_pairwise:
    ...
    round_update = {
        ...
        "round_log_loss": float(avg_ll) if completed else None,
        "round_accuracy": float(accuracy) if completed else None,
    }
